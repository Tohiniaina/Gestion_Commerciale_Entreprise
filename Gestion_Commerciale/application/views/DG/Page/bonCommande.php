...
<main role="main" class="container" class="main-content" style="margin-bottom: 50px;">
			...
			<div class="row mt-5">
				...
				<div class="row mt-4">
					<div class="col-md-2 text-center">
						<p>Signature DG</p>
						<?php if ($boncommande['etat'] == 3 || $boncommande['etat'] == 5) { ?>
							<img src="<?php echo base_url('assets/img/signature.png'); ?>" alt="">
						<?php } ?>
					</div>
	...
	<a href="<?php echo site_url("GeneratePDF/genererPDF/".$boncommande['idboncommande']);?>"><button class="btn btn-success" style="margin-top: 30px; float">Exporter PDF</button></a>

	<?php if ($boncommande['etat'] == 3) { ?>
		<a href="<?php echo site_url("ViewDG/Envoyer/".$boncommande['idboncommande']);?>"><button class="btn btn-success" style="margin-top: 30px; float">Envoyer</button></a>
	<?php } else { ?>
		<a href="<?php echo site_url("ViewDG/Signer/".$boncommande['idboncommande']);?>"><button class="btn btn-info" style="margin-top: 30px; float">Signer</button></a>
	<?php } ?>
</main>
